...
function DateTime() {
	...
	else days = Math.round(this.absoluteDays(year, month, day));
...
DateTime.prototype = {
	...
	absoluteDays: function(year, month, day) {
		...
		var arr = DateTime.isLeapYear(year)
			? new Array(0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335, 366)
			: new Array(0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334, 365);
		var num = year - 1;
	...
	format: function(format) {
		...
		var shortmonths = new Array(
			"",
			DateTime.strings.Jan,
			DateTime.strings.Feb,
			DateTime.strings.Mar,
			DateTime.strings.Apr,
			DateTime.strings.May,
			DateTime.strings.Jun,
			DateTime.strings.Jul,
			DateTime.strings.Aug,
			DateTime.strings.Sep,
			DateTime.strings.Oct,
			DateTime.strings.Nov,
			DateTime.strings.Dec
		);
		var months = new Array(
			"",
			DateTime.strings.January,
			DateTime.strings.February,
			DateTime.strings.March,
			DateTime.strings.April,
			DateTime.strings.MayFull,
			DateTime.strings.June,
			DateTime.strings.July,
			DateTime.strings.August,
			DateTime.strings.September,
			DateTime.strings.October,
			DateTime.strings.November,
			DateTime.strings.December
		);
...
TimeSpan.prototype = {
	...
	rounder: function(number) {
		if (this._millis < 0) return Math.ceil(number);
